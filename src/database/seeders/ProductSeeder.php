    ...
    public function run(): void
    {
        $rows = [
            [
                ...
                'season' => '秋、冬',
                'image_path' => 'fruits-img/kiwi.png',
            ],
            [
                'name' => 'ストロベリー',
                'price' => 1200,
                ...
                'season' => '春',
                'image_path' => 'fruits-img/strawberry.png',
            ],
            [
                'name' => 'オレンジ',
                'price' => 850,
                ...
                'season' => '冬',
                'image_path' => 'fruits-img/orange.png',
            ],
            [
                'name' => 'スイカ',
                'price' => 700,
                ...
                'season' => '夏',
                'image_path' => 'fruits-img/watermelon.png',
            ],
            [
                'name' => 'ピーチ',
                'price' => 1000,
                ...
                'season' => '夏',
                'image_path' => 'fruits-img/peach.png',
            ],
            [
                'name' => 'シャインマスカット',
                'price' => 1400,
                ...
                'season' => '夏、秋',
                'image_path' => 'fruits-img/muscat.png',
            ],
            [
                'name' => 'パイナップル',
                'price' => 800,
                ...
                'season' => '春、夏',
                'image_path' => 'fruits-img/pineapple.png',
            ],
            [
                'name' => 'ブドウ',
                'price' => 1100,
                ...
                'season' => '夏、秋',
                'image_path' => 'fruits-img/grapes.png',
            ],
            [
                'name' => 'バナナ',
                'price' => 600,
                ...
                'season' => '夏',
                'image_path' => 'fruits-img/banana.png',
            ],
            [
                'name' => 'メロン',
                'price' => 900,
                ...
                'season' => '春、夏',
                'image_path' => 'fruits-img/melon.png',
            ],
        ];
